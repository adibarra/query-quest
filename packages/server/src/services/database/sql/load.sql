...
VALUES
  ...
  (14, 'What is the rarest naturally occurring element on Earth?', 3, 'Astatine', 'Francium', 'Plutonium', 'Radon'),
  ...
  (41, 'Who is considered the father of the modern computer?', 2, 'Alan Turing', 'Charles Babbage', 'John von Neumann', 'Steve Jobs'),
  (42, 'What is the name of the first electronic general-purpose computer?', 2, 'ENIAC', 'UNIVAC', 'IBM 701', 'Altair 8800'),
  (43, 'Who founded Microsoft?', 1, 'Bill Gates', 'Steve Jobs', 'Mark Zuckerberg', 'Elon Musk'),
  (44, 'What year was the first iPhone released?', 3, '2007', '2005', '2010', '2012'),
  (45, 'Which company developed the Java programming language?', 1, 'Sun Microsystems', 'Microsoft', 'Oracle', 'Apple'),
  (46, 'What does “HTTP” stand for?', 3, 'Hypertext Transfer Protocol', 'Hyperlink Text Protocol', 'High Transfer Text Protocol', 'Hyper Transfer Protocol'),
  (47, 'Who invented the World Wide Web?', 1, 'Tim Berners-Lee', 'Vint Cerf', 'Bill Gates', 'Steve Wozniak'),
  (48, 'Which technology is used to make telephone calls over the Internet?', 1, 'VoIP', 'Wi-Fi', 'NFC', 'Bluetooth'),
  (49, 'What is the name of the first man-made satellite?', 1, 'Sputnik', 'Explorer 1', 'Voyager', 'Luna 1'),
  (50, 'Which programming language is known as the "mother of all languages"?', 3, 'Assembly', 'Fortran', 'C', 'BASIC'),
  (51, 'In Greek mythology, who is the king of the gods?', 1, 'Zeus', 'Hades', 'Poseidon', 'Apollo'),
  (52, 'What is the name of the Norse god of thunder?', 1, 'Thor', 'Loki', 'Odin', 'Frey'),
  (53, 'Who is the Roman goddess of love?', 3, 'Venus', 'Juno', 'Minerva', 'Diana'),
  (54, 'What is the name of the legendary sword of King Arthur?', 1, 'Excalibur', 'Durendal', 'Joyeuse', 'Gram'),
  (55, 'Which Greek hero completed 12 labors as penance?', 2, 'Hercules', 'Achilles', 'Odysseus', 'Perseus'),
  (56, 'What creature is part lion, part goat, and part snake in Greek mythology?', 1, 'Chimera', 'Cerberus', 'Minotaur', 'Hydra'),
  (57, 'In Egyptian mythology, who is the god of the underworld?', 2, 'Osiris', 'Ra', 'Anubis', 'Thoth'),
  (58, 'Which figure is said to have stolen fire for humanity in Greek mythology?', 2, 'Prometheus', 'Hermes', 'Hephaestus', 'Apollo'),
  (59, 'What is the name of the female warriors in Greek mythology?', 3, 'Amazons', 'Furies', 'Nymphs', 'Harpies'),
  (60, 'Who is the Celtic goddess of war and death?', 2, 'Morrigan', 'Brigid', 'Danu', 'Aine')
ON CONFLICT (id) DO NOTHING;
